...
import type { Order as _Order, OrderItem as _OrderItem, Product as _Product, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: Array<OrderItem>): Promise<Order | null> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrder(to_candid_vec_n3(this._uploadFile, this._downloadFile, arg0));
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        engravingText: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.engravingText)),
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        orderStatus: from_candid_variant_n9(_uploadFile, _downloadFile, value.orderStatus),
        orderId: value.orderId,
        totalAmount: value.totalAmount,
        checkoutSessionId: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.checkoutSessionId)),
...
function to_candid_OrderItem_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrderItem): _OrderItem {
...
function to_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        engravingText: value.engravingText ? candid_some(value.engravingText) : candid_none(),
        quantity: value.quantity,
        product: value.product
    };
}
...
function to_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<OrderItem>): Array<_OrderItem> {
    return value.map((x)=>to_candid_OrderItem_n4(_uploadFile, _downloadFile, x));
}
